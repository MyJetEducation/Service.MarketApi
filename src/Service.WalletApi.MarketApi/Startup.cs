...
using Service.WalletApi.MarketApi.Modules;
using Service.Core.Client.Constants;

namespace Service.WalletApi.MarketApi
{
	public class Startup
	{
		...
		{
			StartupUtils.SetupWalletApplication(app, env, Program.Settings.EnableApiTrace, "market");
